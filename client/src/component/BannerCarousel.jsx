    ...
    return(
        <Carousel className="max-w-screen-lg mx-auto mt-4 relative" autoPlay interval={3000} infiniteLoop showStatus={false} showThumbs={false}>
           <div>
                ...
                {/* <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-4xl font-bold">The World is Too big to Explore alone; find your travel mate and conquer it.</div> */}
            </div>
            ...
            <div>
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-4xl font-bold">Life is Short, let`s Wander together</div>
            </div>
            <div>
